...
class PoseRelationModule(nn.Module):
    ...
    def __PositionalEmbedding(self, f_g, dim_g=8, wave_len=1000):
...
class RelationModule(nn.Module):
    def __init__(self,n_relations = 27, appearance_feature_dim=216,key_feature_dim = 8, geo_feature_dim = 8):
    ...
    def forward(self, input_data ):
        ...
        return (concat+f_a).view(-1, 24, 3, 3)

class RelationUnit(nn.Module):
    def __init__(self, appearance_feature_dim=216,key_feature_dim = 8, geo_feature_dim = 8):

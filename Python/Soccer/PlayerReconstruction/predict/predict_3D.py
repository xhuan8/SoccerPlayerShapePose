...
def setup_detectron2_predictors(silhouettes_from='densepose'):
    ...
    if silhouettes_from == 'pointrend':
        ...
        pointrend_config_file = "PlayerReconstruction/PointRend/configs/InstanceSegmentation/pointrend_rcnn_R_50_FPN_3x_coco.yaml"
        pointrend_cfg = get_cfg()
        add_pointrend_config(pointrend_cfg)
        pointrend_cfg.merge_from_file(pointrend_config_file)
        pointrend_cfg.MODEL.WEIGHTS = "PlayerReconstruction/checkpoints/pointrend_rcnn_R_50_fpn.pkl"
        ...
        densepose_config_file = "PlayerReconstruction/DensePose/configs/densepose_rcnn_R_101_FPN_s1x.yaml"
        densepose_cfg = get_cfg()
        add_densepose_config(densepose_cfg)
        densepose_cfg.merge_from_file(densepose_config_file)
        densepose_cfg.MODEL.WEIGHTS = "PlayerReconstruction/checkpoints/densepose_rcnn_R_101_fpn_s1x.pkl"
